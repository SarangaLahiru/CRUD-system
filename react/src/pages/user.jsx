...
export default function User() {
  ...
  const getUsers=()=>{
    console.log(axiosClient.get('/users'))
    setLoad(true)
...
<td class="px-6 py-4">
<Link to={'users/'+u.id} className="font-medium btn btn-primary">update</Link>
</td>
<td class="px-6 py-4 ">
<Link onClick={()=>onDelete(u)} class="font-medium btn btn-danger">delete</Link>
</td>
</tr>
         ))}
